...
/***/ function(module, exports) {
  ...
  module.exports = "<p>If you are working behind a company proxy or you have a local proxy running, it&#39;s necessary to tell Inkdrop to go through it.\nHere is a quick tip for those dealing with a proxy.</p>\n<p>You can configure the web proxy settings by editing <code>config.cson</code>. This config file is in following directory:</p>\n<ul>\n<li>on macOS: <code>~/Library/Application Support/inkdrop/config.cson</code></li>\n<li>on Windows: <code>%APPDATA%/inkdrop/config.cson</code></li>\n<li>on Linux: <code>~/.config/inkdrop/config.cson</code></li>\n</ul>\n<p>Quit Inkdrop before you edit it.</p>\n<pre><code class=\"lang-yaml\"><span class=\"hljs-string\">\"*\"</span>:\n<span class=\"hljs-attr\">  core:</span>\n<span class=\"hljs-attr\">    network:</span>\n<span class=\"hljs-attr\">      http_proxy:</span> <span class=\"hljs-string\">\"http://username:password@localhost:8080/\"</span>\n<span class=\"hljs-attr\">      https_proxy:</span> <span class=\"hljs-string\">\"http://username:password@localhost:8080/\"</span>\n</code></pre>\n<p>Now open Inkdrop and you will be able to get synced!</p>\n<h2><a name=\"configuring-ipm\" class=\"anchor\" href=\"#configuring-ipm\"><i class=\"linkify icon\"></i></a>Configuring ipm</h2><p><code>ipm</code> is also necessary to be configured for working behind a web proxy.</p>\n<pre><code class=\"lang-bash\">ipm config <span class=\"hljs-built_in\">set</span> proxy <span class=\"hljs-string\">\"http://localhost:3128\"</span>\nipm config <span class=\"hljs-built_in\">set</span> https_proxy proxy <span class=\"hljs-string\">\"http://localhost:3128\"</span>\n</code></pre>\n";
